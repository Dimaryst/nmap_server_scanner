...
SOCKET_FILE = './uds_socket'  # Replace with server address
...
try:
    client.connect(SOCKET_FILE)  # пытаемся подключиться к серверу
...
except FileNotFoundError:  # если соединение не удалось выводим ошибку
